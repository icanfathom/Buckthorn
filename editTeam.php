	...
	<div class="col s12 l5">
		<div class="row">
			<form action="processTeam.php" method="post">
				...
				<div class="col s3">
					<a href="#modal1" class="btn-floating waves-effect waves-light edit-team"><i class="material-icons">mode_edit</i></a>
					<button type="submit" name="action" value="delete" class="btn-floating waves-effect waves-light red darken-3"><i class="material-icons">delete</i></button>
		...
		<?php foreach ($students as $student): ?>
			<div class="row student-list">
				<form action="processTeam.php" method="post">
					...
					<div class="col s3">
						<a href="#modal2" class="btn-floating waves-effect waves-light edit-student"><i class="material-icons">mode_edit</i></a>
						<button type="submit" name="action" value="delete" class="btn-floating waves-effect waves-light red darken-3"><i class="material-icons">delete</i></button>
		...
		<div class="row">
			<div class="col s9">
				<a href="#modal2" class="btn waves-effect waves-light add-student"><i class="material-icons right">add</i>New student</a>
			</div>
		</div>
	</div>
		...
		<div class="modal-content">
			<form action="processTeam.php" method="post">
				<div class="row">
					...
					<div class="col s6 l3">
						<button class="btn waves-effect waves-light submit-action-edit" type="submit" name="action" value="edit"><i class="material-icons right">mode_edit</i>Modify</button>
						<a class="red darken-3 btn waves-effect waves-light modal-close"><i class="material-icons right">cancel</i>Cancel</a>
					</div>
				</div>
			</form>
		</div>
		...
		<div class="modal-content">
			<form action="processTeam.php" method="post">
				<div class="row">
					...
					<div class="col s6 l3">
						<button class="btn waves-effect waves-light submit-action-add" type="submit" name="action" value="add"><i class="material-icons right">add</i>Add</button>
						<button class="btn waves-effect waves-light submit-action-edit" type="submit" name="action" value="edit"><i class="material-icons right">mode_edit</i>Modify</button>
						<a class="red darken-3 btn waves-effect waves-light modal-close"><i class="material-icons right">cancel</i>Cancel</a>
					</div>
				</div>
